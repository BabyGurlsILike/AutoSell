...
namespace babygurllike\AutoSell;
            ...
            case "autosell":
                ...
                if($sender->hasPermission("autosell.command")){
                    ...
                    if($sender instanceof Player){
                        ...
                        $sender->sendMessage($prefix . " " . TextFormat::RED . "Tu peux juste use cette command ingame !");
                    }

                } else {

                    $sender->sendMessage($prefix . " " . TextFormat::RED . "Tu n'a pas la perm de faire cette command !");
                }
        }
                    ...
                    if(!$event->getPlayer()->isCreative()) {
                        if(in_array($event->getPlayer()->getWorld()->getFolderName(), $this->getConfig()->get("worlds"))) {
                            ...
                            if(!(isset($con[$item]))) {
                                ...
                                $event->getPlayer()->sendTip(TextFormat::RED . "Ce block n'est pas en solde !");
                            ...
                            $event->getPlayer()->sendTip(TextFormat::RED . "Tu ne peux pas use le AutoSell dans ce monde !");

                        }

                    } else {

                        $event->getPlayer()->sendTip(TextFormat::RED."Tu ne peux pas AutoSell en Creatif !");

                    }

                } else {

                    $event->getPlayer()->sendTip(TextFormat::RED . "Tu ne peux pas vendre avec le AutoSell 1");
